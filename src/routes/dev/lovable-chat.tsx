      ...
      },
      {
        ...
        miniCard: {
          ...
          activity: [
            ...
            { id: "t2", label: "Conectar rota browser execute", status: "done" },
          ],
        },
        finished: false,
      },
    ...
    items: [
      {
        ...
        miniCard: {
          ...
          status: "working",
          activity: [
            { id: "t1", label: "Higienizar Dockerfile.lara", status: "done" },
            { id: "t2", label: "Conectar rota browser execute", status: "done" },
            { id: "t3", label: "Proteção anti-destrutivo", status: "done" },
            { id: "t4", label: "Auto-save de scripts persistente", status: "done" },
            { id: "t5", label: "Regenerar bundles e redeploy", status: "done" },
          ],
