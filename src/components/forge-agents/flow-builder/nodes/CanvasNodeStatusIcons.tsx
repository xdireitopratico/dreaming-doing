...
export function RunningSpinner({ size = 16 }: StatusIconProps) {
  return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={{ color: "var(--ps-accent, #3b82f6)" }} className="animate-spin">
...
export function PinnedMark({ size = 16 }: StatusIconProps) {
  return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={{ color: "var(--ps-accent, #60a5fa)" }}>
