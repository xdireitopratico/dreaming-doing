/**
 * PrometheusPhaseHeader — compact Deep Blue workflow rail
 */
...
export function PrometheusPhaseHeader({
  ...
  const currentWorkflowIdx = Math.max(0, WORKFLOW_STAGES.findIndex((stage) => stage.id === activeWorkflow));
  // Use the workflow stage label as the screen label (synced with the rail)
  ...
  return (
    <div className="prometheus-studio flex-shrink-0 border-b" style={{ borderColor: "var(--ps-border)", background: "var(--ps-bg-deep)" }}>
      <div className="flex items-center gap-3 px-4 py-3 sm:px-6">
        ...
        {/* Model + Convergence + Round + Collapse */}
