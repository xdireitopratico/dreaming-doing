...
import { Toaster as SonnerToaster, toast as sonnerToast, type ToastT, type ExternalToast } from "sonner";
...
const icons = {
  ...
  loading: (
    <svg className="h-5 w-5 animate-spin text-brand-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
