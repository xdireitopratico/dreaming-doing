// _events.ts — Mirror Deno do contrato de eventos do agente.
//
// Este arquivo é uma cópia EXATA de src/lib/agent-event-contract.ts para uso
// no lado Deno (supabase/functions). Deno não resolve os aliases Vite (@/),
// portanto mantemos um mirror manual. Ao alterar o arquivo fonte, sincronize
// este mirror.
//
// Single source of truth: src/lib/agent-event-contract.ts
//
// Para evitar drift entre os dois arquivos, um teste de paridade
// (events-parity.test.ts) compara o conteúdo.
